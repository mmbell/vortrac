...
class Dorade : public RadarData
{
	
public:
	// Constructor / Destructor
	Dorade(const QString &radarname, const float &lat, const float &lon, const QString &filename);
	~Dorade();
...
private:
	...
	/* PROTOTYPES */
	bool sweepread(const char swp_fname[],struct sswb_info *ssptr, struct vold_info *vptr,
