...
class GriddedData 
{
 ...
 public:
  ...
  float* getCartesianXslice(const QString& fieldName, const float& y,const float& z);
  ...
  float* getSphericalRangeData(QString& fieldName, float azimuth,float elevation);
  float* getSphericalRangeData(QString& fieldName, float azimuth,float elevation, int numPoints);
  ...
  float* getSphericalAzimuthData(QString& fieldName, float range,float elevation);
  float* getSphericalAzimuthPosition(float range, float elevation);
  int    getSphericalElevationLength(float range, float elevation);
  float* getSphericalElevationData(QString& fieldName, float range,float azimuth);
  ...
  float* getSphericalRangeDataTest(QString& fieldName, float azimuth,float elevation);
  ...
  float* getCylindricalRadiusData(QString& fieldName, float azimuth,float height);
  float* getCylindricalRadiusPosition(float azimuth, float height);
  int    getCylindricalAzimuthLength(float radius, float height);
  void   getCylindricalAzimuthData(QString& fieldName,int numPoints, float radius, float height, float* values);
  ...
  float* getCylindricalHeightData(QString& fieldName, float radius,float height);
  ...
  void getCylindricalAzimuthDataTest2(QString& fieldName,int numPoints, float radius,float height, float* values);
